...
@app.route('/voice/<ph>',methods=['GET'])
def voice(ph):
    print "DEV"*3
    response = VoiceResponse()
    welcome_user(response.say)
    redirect_to_first_question(response,ph)
    return str(response)
...
def welcome_user(send_function):
    welcome_text = 'Welcome to the HDFC life This is an autogenerated call for confirming details '
...
def question(question_id):
    ...
    return voice_twiml(question_id)
